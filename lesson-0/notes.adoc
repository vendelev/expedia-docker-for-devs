...
When you create a VM you need to emulate every component of the machine, you should install a full OS, you should secure it and you should configure it to run your service.
...
Docker use all the resources of your host machine and it just creates an isolated filesystem (using https://en.wikipedia.org/wiki/UnionFS[UFS]) where to run your service.
This approach is lighter, more secure and faster.
...
Delete some core files (like /etc for instance).
